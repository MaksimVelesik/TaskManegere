...
namespace TaskManager
{
    ...
    {
        public ObservableCollection<Task> AllTasks { get; } = new ObservableCollection<Task>();
        ...
        {
            var filteredTasks = new ObservableCollection<Task>(AllTasks.Where(t => t.Status == status));
